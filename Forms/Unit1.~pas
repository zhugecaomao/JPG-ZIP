...
//  Self.StatusBar1.Panels[2].Text := DateTimeToStr(Now);
  Self.StatusBar1.Panels[2].Text := 'http://weibo.com/zhugecaomao';
  Self.StatusBar1.Panels[1].Text := '软件作者：诸葛草帽';
  Self.StatusBar1.Panels[0].Text := '准备就绪';
...
case MessageBox(Handle,
  '                【By 诸葛草帽 2014.4】' + #13#10 +
  #13#10 + '本软件能够批量的将JPG图片格式文件与RAR|ZIP格式压缩文件' + #13#10#13#10
  ...
  + '一点是可以比较好的隐藏个人文件，充分发挥你的想象力吧...' + #13#10#13#10 +
   '是否访问官方网站检查软件更新？' + #13#10 + #13#10, '软件说明：', MB_OKCANCEL +
  MB_ICONINFORMATION + MB_TOPMOST) of
  IDOK:
    begin
    ShellExecute(Handle,nil,'explorer.exe',pchar('http://zhugecaomao.jimdo.com?jpg-rar-1.3'),nil,SW_Hide);
    end;
  IDCANCEL:
    begin
